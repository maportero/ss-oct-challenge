...
if ( ! defined( 'X_BLOG_VERSION' ) ) {
	// Replace the version number of the theme on each release.
	define( 'X_BLOG_VERSION', '1.3.15' );
}
...
function x_blog_scripts() {
    ...
    wp_enqueue_style( 'block-style', get_template_directory_uri() . '/assets/css/block.css', array(), X_BLOG_VERSION );
	wp_enqueue_style( 'xblog-style', get_stylesheet_uri() );
	wp_enqueue_style( 'xblog-responsive', get_template_directory_uri() . '/assets/css/responsive.css', array(),X_BLOG_VERSION,'all' );

	
	wp_enqueue_script( 'jquery');
	wp_enqueue_script( 'xblog-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), X_BLOG_VERSION, true );
	...
	wp_enqueue_script( 'xblog-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), X_BLOG_VERSION, true );
 ...
 * Header action
 */
require get_template_directory() . '/inc/header-action.php';
